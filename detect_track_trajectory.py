...
#2021
# use:python detect_track_UI_v5.py --source videos/sample.mp4 --cfg cfg/yolor_p6.cfg --weights yolor_p6.pt --conf 0.5 --img-size 1280 --device 0 --view-img
...
def draw_boxes(img, bbox, object_id, identities=None, offset=(0, 0)):
    ...
    #2. remove tracked point from buffer if object is lost
