# use: python detect_track_UI_new.py --source ../1_1.mp4 --cfg cfg/yolor_p6.cfg --weights yolor_p6.pt --conf 0.25 --img-size 1280 --device 0 #--view-img
import argparse
import os
import platform
import shutil
...
# line3 = [(150,550), (1100, 550)]
# line4 = [(100,600), (1150, 600)]
...
def draw_boxes(img, bbox, object_id, identities=None, offset=(0, 0)):
    ...
    # cv2.line(img, line1[0], line1[1], (0, 255, 255), 3)
    cv2.line(img, line2[0], line2[1], (46,162,112), 3)
    # cv2.line(img, line3[0], line3[1], (0, 255, 255), 3)
    # cv2.line(img, line4[0], line4[1], (0, 255, 255), 3)
    ...
    for i, box in enumerate(bbox):
        ...
        if len(data_deque[id]) >= 2:
            ...
            if intersect(data_deque[id][0], data_deque[id][1], line2[0], line2[1]):# or intersect(data_deque[id][0], data_deque[id][1], line1[0], line1[1]) or intersect(data_deque[id][0], data_deque[id][1], line3[0], line3[1]) or intersect(data_deque[id][0], data_deque[id][1], line4[0], line4[1]) :
                ...
                # print(speed_four_line_queue)
                # print("Name of Object", obj_name)
        ...
        # print("speed_four_line_queue", speed_four_line_queue)
        ...
        try:
            ...
            label = label + " " + str(sum(speed_four_line_queue[id])//len(speed_four_line_queue[id])) + "km/h"
    ...
    # cv2.line(img, (width - 100 ,25), (width - 5,25), [85,45,255], 30)

    # object_counter_str = re.sub('[^A-Za-z0-9,]+', '', str(object_counter))   
    # cv2.putText(img, str(object_counter_str), (width - 100, 35), 0, 1, [225, 255, 255], thickness=2, lineType=cv2.LINE_AA)
